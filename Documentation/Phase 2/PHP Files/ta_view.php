...
function assignmentsView($connection, $var1){
  ...
  $result = mysqli_query($connection, "SELECT * from ta_assignments where email = '$email';");
...
function courseOverviewView($connection, $var1){
  ...
  $result = mysqli_query($connection, "SELECT * from ta_course_overview where email = '$email';");
...
function gradesView($connection, $var1){
  ...
  $result = mysqli_query($connection, "SELECT * from ta_grades where email = '$email';");
...
function studySessionView($connection, $var1){
  ...
  $result = mysqli_query($connection, "SELECT * from ta_study_session where email = '$email';");
